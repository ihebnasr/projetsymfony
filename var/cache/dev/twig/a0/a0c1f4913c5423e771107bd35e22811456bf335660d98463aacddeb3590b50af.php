...
/* register.html.twig */
class __TwigTemplate_7441de2027e095a6f3d72ab014c55a7c449faa66b96e93ab172fd7d14de55a2f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  225 => 119,  200 => 97,  194 => 94,  186 => 89,  180 => 86,  171 => 80,  165 => 77,  157 => 72,  151 => 69,  146 => 66,  144 => 65,  138 => 62,  131 => 58,  125 => 55,  119 => 52,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{{ form_start(form) }}
 ...
 {{ form_row(form.username, { 'label':'Nom d\\'utilisateur', 'attr': {'class': 'form-control','placeholder':'Nom d\\'utilisateur...' } }) }}
                  ...
                  <div class=\"form-group col-md-6\">
                     {{ form_row(form.prenom_candidat, { 'attr': { 'class': 'form-control' ,'placeholder': 'Prenom...' } }  ) }}
...
{% endblock  %}
", "register.html.twig", "C:\\wamp64\\www\\JOB\\templates\\register.html.twig");
    }
}
